...
//     if (guessNum > randNum || (guessNum < randNum ? prompt('Too High. Guess Again.') : prompt('Too Low. Guess Again.')));
//     else {
//         console.log('It took you X guesses.');
//         break;
//     }   
// }

// if (guessNum > randNum) {
//         let guessNum = prompt('Too High. Guess Again.');
//     }
//     else if (guessNum < randNum) {
//         let guessNum = prompt('Too Low. Guess Again.');
//     }
//     else {
//         console.log('It took you X guesses.');
//         break;
//     }    
// input = prompt(guessNum)